...
def player_gps_statistics():
   ...
   # Filter the player DataFrame to only include the selected players
   # filtered_player_team_A = player_df[player_df['Name'].isin(selected_players)]
   # filtered_player_team_B = player_df[player_df['Name'].isin(selected_players)]   
...
# # Allow the user to select multiple players from the list
# selected_players = st.multiselect('Select players', player_names)

# # Filter the player DataFrame to only include the selected players
# filtered_player_df = player_df[player_df['Name'].isin(selected_players)]

# # Display the filtered player DataFrame
# st.write(filtered_player_df)
